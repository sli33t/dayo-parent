...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`worklog` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `tb_area` (
  ...
  `DELETE_FLAG` smallint(6) DEFAULT NULL COMMENT '删除标志',
  `DELETE_DATE` date DEFAULT NULL COMMENT '删除日期',
  `CREATE_TIME` datetime DEFAULT NULL COMMENT '创建时间',
  `ROW_VERSION` smallint(6) DEFAULT NULL COMMENT '行版本号',
  PRIMARY KEY (`AREA_ID`)
...
CREATE TABLE `tb_customer` (
  ...
  `ROW_VERSION` smallint(6) DEFAULT NULL,
...
CREATE TABLE `tb_devtask` (
  ...
  `FEEDBACK_ID` bigint(20) NOT NULL COMMENT '客户反馈编号',
  `DEVELOP_USER_ID` varchar(32) NOT NULL COMMENT '开发人编号',
  `RECEIVED` smallint(6) DEFAULT NULL COMMENT '已接收',
  `RECEIVE_TIME` datetime DEFAULT NULL COMMENT '接收时间',
  `RECEIVE_DATE` date DEFAULT NULL COMMENT '接收日期',
  `FINISHED` smallint(6) DEFAULT NULL COMMENT '开发完成',
  ...
  `IS_PROBLEM` smallint(6) DEFAULT NULL COMMENT '是否是问题',
  `NEED_TEST` smallint(6) DEFAULT NULL COMMENT '是否需要测试',
  `TEST_RECEIVED` smallint(6) DEFAULT NULL COMMENT '测试是否接手',
...
CREATE TABLE `tb_feedback` (
  ...
  `PROBLEM_TYPE` smallint(6) DEFAULT NULL,
  `FEEDBACK_TYPE` smallint(6) DEFAULT NULL,
...
CREATE TABLE `tb_role` (
  ...
  `ROLE_TYPE` smallint(6) DEFAULT NULL COMMENT '岗位类型',
  `ROW_VERSION` smallint(6) DEFAULT NULL COMMENT '行版本号',
  `CREATE_TIME` datetime DEFAULT NULL COMMENT '创建时间',
  `DELETE_FLAG` smallint(6) DEFAULT NULL COMMENT '删除标志',
  `DELETE_DATE` date DEFAULT NULL COMMENT '删除日期',
...
CREATE TABLE `tb_testtask` (
  ...
  `FEEDBACK_ID` bigint(20) NOT NULL COMMENT '客反单号',
