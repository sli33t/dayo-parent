package cn.caishen.worklog.queue;

import cn.caishen.domain.domain.po.User;
import cn.caishen.domain.utils.LbMap;
import cn.caishen.worklog.config.GetHttpSessionConfigurator;
import cn.caishen.worklog.constant.MQConstant;
import cn.caishen.worklog.utils.DateUtil;
                    ...
                    try {
                        ...
                        if (message!=null){
                            ...
                            if (httpSession!=null){
                                ...
                                Object userStr = httpSession.getAttribute("user");
